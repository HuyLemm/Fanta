...
// Handling genre list scrolling
const genreSections = document.querySelectorAll('.genre-section');

genreSections.forEach(section => {
    const prevButton = section.querySelector('.prev-genre');
    const nextButton = section.querySelector('.next-genre');
    const genreItems = section.querySelector('.genre-items');
